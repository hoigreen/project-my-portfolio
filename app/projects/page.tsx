...
const uniqueCategories = ['All Projects', ...new Set(projectsData.map((item: any) => item.category))];

const MyProjects = () => {
  const [categories, setCategories] = useState(uniqueCategories)
  const [currentCategory, setCurrentCategory] = useState('All Projects')

  const filteredProjects = projectsData.filter(item => currentCategory === 'All Projects' ? item : item.category === currentCategory)
