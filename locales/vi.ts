export default {
  ...
  aboutPersonalHonorsAwards: 'Giải thưởng & Danh hiệu',
  aboutQualificationsHeader: 'Hành trình tuyệt vời của tớ',
  aboutSkillsHeader: 'Kỹ năng của tớ',
  aboutSkillsTools: 'Công cụ mà tớ hay dùng',
  education: 'Quá trình học tập',
  roleDescription: "Tất cả vai trò tớ đã tham gia với nhiệt huyết và đam mê.",
